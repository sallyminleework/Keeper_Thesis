...
function setup() {
  ...
  fill(0, 0, 0, 255);
  voice = new p5.Speech('Google UK English Female', speechLoaded); // speech synthesis object
...
function parseResult() {
  ...
  /*
  if (myString == "hello") {
    // text to speech says hello
    console.log("computer says hello");
    myString = "";
  } else
  */
  console.log("i heard " + myString);

  let lookfor = "hi keeper";
  let matches = matchAll(myString, lookfor);
  if (matches.length > 0 && convoPos == 0) {
    console.log("Hi Alice, so good to hear from you. How are you feeling today?");
    voice.speak("Hi Alice, so good to hear from you. How are you feeling today?");
    convoPos = 1;
  }

  if (myString == "I'm pretty happy" && convoPos == 1) {
    console.log("Oh that's great! Could you describe what made you happy today?");
    voice.speak("Oh that's great! Could you describe what made you happy today?");
    myString = "";
    convoPos = 2;
  }
  // console.log(matches);
  
  if (myString == "I finished my homework fast but I'm tired" && convoPos == 2) {
    console.log("You must be tired after all the studying. Do you want to draw in your journal today?");
    voice.speak("You must be tired after all the studying. Do you want to draw in your journal today?");
    myString = "";
    convoPos = 3;
  }

    if (myString == "yes sure" && convoPos == 3) {
    console.log("Okay great let me pull up your journal");
    voice.speak("Okay great let me pull up your journal");
    myString = "";
    convoPos = 4;
  }
  
//      if (myString == "I want to draw about it" && convoPos == 4) {
 //   console.log("Sure, let me pull up your journal");
 //   voice.speak("Sure, let me pull up your journal");
 //   myString = "";
 //   convoPos = 5;
 // }
